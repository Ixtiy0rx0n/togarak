...
function clubCard(club: { title: string; imagePath: string; paragraph: string; description: string; teacherName: string }): string {
    return `
...
async function initPage(): Promise<void> {
    ...
    const searchInput = byId<HTMLInputElement>("heroSearchInput");
