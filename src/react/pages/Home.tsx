...
import { getPublicSnapshot } from '../../core/store';
        ...
        <div className="flex min-h-screen relative overflow-hidden">
            ...
            <aside className="w-64 bg-[#0d1520] border-r border-gray-800 hidden md:flex flex-col shrink-0 z-10">
                ...
                <nav className="flex-1 py-6 px-4 space-y-2">
                    ...
                    <button onClick={() => setPage('admin')} className="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors">Admin Panel</button>
                </nav>
            ...
            <div className="flex-1 flex flex-col relative z-10">
                <header className="md:hidden bg-[#0d1520] border-b border-gray-800 sticky top-0 z-20">
                    <div className="px-6 py-4 flex justify-between items-center">
                        ...
                        <button onClick={() => setPage('admin')} className="text-sm text-blue-400">Admin</button>
                    </div>
                </header>
                ...
                <main className="flex-1 overflow-y-auto">
                    ...
                    <section className="relative bg-[#0d1520] text-white py-16 md:py-24 overflow-hidden border-b border-gray-800">
                        <div className="container mx-auto px-6 lg:px-12 relative z-10">
                            <span className="inline-block py-1.5 px-4 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold uppercase tracking-wider mb-6">
                                Yangi o'quv mavsumi ochiq
                            </span>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight tracking-tight text-white max-w-4xl">
                                Gulistondagi zamonaviy <br className="hidden md:block" />
                                <span className="text-blue-500">to'garaklar platformasi</span>
                            </h1>
                            <p className="text-lg text-gray-400 mb-10 max-w-2xl font-light leading-relaxed">
                                O'zingizga mos to'garakni tanlang va bilimingizni oshiring. Barcha ma'lumotlar real vaqtda yangilanadi.
                            </p>
                            ...
                            <div className="flex flex-col md:flex-row max-w-3xl bg-[#1a2234] border border-gray-700 rounded-xl p-1.5 shadow-2xl gap-2 md:gap-0">
                                <div className="flex-1 flex items-center px-4">
                                    <input
                                        type="text"
                                        placeholder="Fan yoki to'garak nomini qidiring..."
                    ...
                    <section className="container mx-auto px-6 lg:px-12 py-16">
                        <div className="flex justify-between items-end mb-8 border-b border-gray-800 pb-4">
                            <div>
                                <h2 className="text-2xl md:text-3xl font-bold text-white">Tavsiya etilgan to'garaklar</h2>
                                <p className="text-sm text-gray-500 mt-2">Bizning eng mashhur to'garaklarimiz bilan tanishing.</p>
                            </div>
                            ...
                            {filteredClubs.slice(0, 8).map(club => (
                                <div key={club.id} className="bg-[#0d1520] border border-gray-800 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all group">
                                    <div className="h-48 overflow-hidden">
                                        <img src={club.imagePath} alt={club.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                    </div>
                                    <div className="p-5">
                                        ...
                                        <button onClick={() => setPage('clubs')} className="w-full py-2 rounded-lg bg-blue-600/10 text-blue-400 text-sm font-medium hover:bg-blue-600 hover:text-white transition-all">Batafsil</button>
                                    </div>
                                </div>
                            ))}
                    ...
                    <section className="py-12 border-t border-gray-800">
                        <div className="container mx-auto px-6 lg:px-12">
                            <div className="bg-gradient-to-r from-blue-900 to-[#0d1b2a] rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between text-white border border-blue-800/50 shadow-2xl">
                                <div>
                                    <h2 className="text-2xl font-bold mb-2">O'qituvchi yoki adminmisiz?</h2>
                                    <p className="text-blue-200 text-sm">O'z kabinetingizga kiring va ma'lumotlarni boshqaring.</p>
                                </div>
                                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                                    <button onClick={() => setPage('admin')} className="bg-white/10 px-5 py-3 rounded-lg hover:bg-white/20 transition-colors">Admin Panel</button>
                                    <button onClick={() => setPage('teacher')} className="bg-blue-600 px-5 py-3 rounded-lg hover:bg-blue-500 transition-colors">Teacher Panel</button>
                                </div>
                            </div>
                        </div>
                    </section>
